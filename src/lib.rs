...
/// Abstraction for [`lcs_diff::DiffResult`] and [`wu_diff::DiffResult`] that excludes a variant for
/// common sequence, stores a clone of inserted items, and indices relate iteratively to `a`.
///
/// [`lcs_diff::DiffResult`]: https://docs.rs/lcs-diff/latest/lcs_diff/enum.DiffResult.html
/// [`wu_diff::DiffResult`]: https://docs.rs/wu-diff/latest/wu_diff/enum.DiffResult.html
#[derive(Debug)]
